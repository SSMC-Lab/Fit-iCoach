...
public class ModelData_Right {
    public static final String TAG = "ModelData_Right";
...
//            "1_1.txt", "3_1.txt","13_1.txt", "14_1.txt","16_1.txt"
            "Template-right/1.txt", "Template-right/2.txt", "Template-right/3.txt", "Template-right/4.txt", "Template-right/5.txt", "Template-right/6.txt", "Template-right/7.txt",
            "Template-right/8.txt", "Template-right/9.txt", "Template-right/10.txt", "Template-right/11.txt", "Template-right/12.txt", "Template-right/13.txt", "Template-right/14.txt", "Template-right/15.txt"
//            "Template-personal/16.txt", "Template-personal/17.txt", "Template-personal/18.txt", "Template-personal/19.txt", "Template-personal/20.txt"
    ...
    public ModelData_Right(Context con) {
        context = con;
