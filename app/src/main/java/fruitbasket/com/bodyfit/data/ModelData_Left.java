...
public class ModelData_Left {
    public static final String TAG = "ModelData_Left";
...
//            "1_1.txt", "3_1.txt","13_1.txt", "14_1.txt","16_1.txt"
            "Template-left/1.txt", "Template-left/2.txt", "Template-left/3.txt", "Template-left/4.txt", "Template-left/5.txt", "Template-left/6.txt", "Template-left/7.txt",
            "Template-left/8.txt", "Template-left/9.txt", "Template-left/10.txt", "Template-left/11.txt", "Template-left/12.txt", "Template-left/13.txt", "Template-left/14.txt", "Template-left/15.txt"
//            "Template-personal/16.txt", "Template-personal/17.txt", "Template-personal/18.txt", "Template-personal/19.txt", "Template-personal/20.txt"
    ...
    public ModelData_Left(Context con) {
        context = con;
