...
/**
 * Created by Franklin on 3/31/2018.
 */

public class ModelData_Manual {
    public static final String TAG = "ModelData_Manual";
...
//            "1_1.txt", "3_1.txt","13_1.txt", "14_1.txt","16_1.txt"
            "Template-personal/1.txt", "Template-personal/2.txt", "Template-personal/3.txt", "Template-personal/4.txt", "Template-personal/5.txt", "Template-personal/6.txt", "Template-personal/7.txt",
            "Template-personal/8.txt", "Template-personal/9.txt", "Template-personal/10.txt", "Template-personal/11.txt", "Template-personal/12.txt", "Template-personal/13.txt", "Template-personal/14.txt", "Template-personal/15.txt"
//            "Template-personal/16.txt", "Template-personal/17.txt", "Template-personal/18.txt", "Template-personal/19.txt", "Template-personal/20.txt"
    };
    //储存模板的空间
    ...
    public ModelData_Manual(Context con) {
        context = con;
